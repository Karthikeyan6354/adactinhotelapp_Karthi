...
public class TC105_BookingConfirmationTest extends BaseClass {
	
	@Test(groups="Functional")
	public void BookingConfirmation() throws InterruptedException {
		try
		{
    	logger.info("********Started TC105_BookingConfirmationTest*******");
	    ...
	    Thread.sleep(3000);
		logger.info("*****TC105_BookingConfirmationTest Finished*********");
	}
